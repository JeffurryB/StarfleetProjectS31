...
<head>
    ...
    <style>
        ...
        .lcars-bar-top::before { content: "ERR-ROUTE-403"; position: absolute; left: 25px; bottom: 3px; color: #000000; font-weight: bold; font-size: 14px; }
    ...
    <div class="lcars-container">
        ...
        <main class="lcars-main-panel">
            <div>
                ...
                <a href="welcome.php" class="engage-btn">RETURN TO MAIN SYSTEM</a>
            </div>
        </main>
    </div>
</body>
