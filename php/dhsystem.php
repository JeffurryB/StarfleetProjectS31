                ...
                <section class="lcars-admin-section" style="border-left-color: var(--lcars-blue); margin-top: 25px;">
                    ...
                    <form method="POST" action="process_member_edit.php">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-row"><label for="input_gender">GENDER</label><input type="text" id="input_gender" name="gender" class="lcars-input" value="<?php echo htmlspecialchars($member_data['gender'] ?? ''); ?>" placeholder="1 = MALE/2 = FEMALE/3 = OTHER"></div>
                            ...
                            <div class="form-row"><label for="input_promotions">PROMOTIONS</label><input type="number" id="input_promotions" name="promotions_count" class="lcars-input" value="<?php echo htmlspecialchars($member_data['promotions_count'] ?? ''); ?>" placeholder="0"></div>
