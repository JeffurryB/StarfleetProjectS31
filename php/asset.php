...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($raw_uuid) || empty($raw_name) || empty($raw_type)) {
        ...
        if ($stmt_upload = $db->prepare($AssetUpload)) {
            ...
            if ($stmt_upload->execute()) {
                ...
                if ($stmt_perms = $db->prepare($perms_sql)) {
                    ...
                    if ($stmt_perms->execute()) {
                        ...
                        $status_message = "PARTIAL SUCCESS | ASSET INJECTED BUT PERMISSION SET METRIC FAILURE: " . htmlspecialchars($db->error);
                        $status_type = "failure";
                    }
                    $stmt_perms->close();
                } else {
        ...
        <main class="lcars-main-panel">
            ...
            <section class="lcars-admin-section">
                ...
                <form method="POST" action="asset.php">
                    ...
                    <!-- 🛠️ NEW SUBSYSTEM MODULE: Asset Permissions Matrix Checkboxes -->
